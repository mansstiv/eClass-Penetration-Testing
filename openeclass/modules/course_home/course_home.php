...
if ($is_adminOfCourse) {
        if (isset($_REQUEST['edit_submit'])) {
                        ...
                        if(empty($_SESSION['key_8ematikh_enothta'])){
            $csrftoken_text = md5(openssl_random_pseudo_bytes(32,$cstrong));
            $_SESSION['key_8ematikh_enothta'] = $csrftoken_text;
            }
            $csrftoken = hash_hmac('sha256','this is a random text:newtopic' . $_SESSION['key_8ematikh_enothta'],session_id());
            if(hash_equals($csrftoken,$csrf))
            {

                unset($_SESSION['key_8ematikh_enothta']);
                $_SESSION['key_8ematikh_enothta']='';
            }
            else
            {
                session_destroy();
...
while ($cu = mysql_fetch_array($sql)) {
                ...
                if ($is_adminOfCourse) { // display actions
                        $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\">".
                                ...
                                "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='$urlPath?del=$cu[id]' " .
                                "onClick=\"return confirmation();\">" .
                                "<img src='../../template/classic/img/delete.gif' " .
                                "title='$langDelete'></img></a></td>" .
                                "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='$urlPath?vis=$cu[id]'>" .
                                "<img src='../../template/classic/img/$icon_vis' " .
                                "title='$langVisibility'></img></a></td>";
                        if ($cu['id'] != $last_id) {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='$urlPath?down=$cu[id]'>" .
                                "<img src='../../template/classic/img/down.gif' title='$langDown'></img></a></td>";
                        } else {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                        }
                        if (!$first) {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\"><a href='$urlPath?up=$cu[id]'><img src='../../template/classic/img/up.gif' title='$langUp'></img></a></td>";
                        } else {
                                $cunits_content .= "\n        <td width='2%' style=\"border-bottom: 1px solid #CAC3B5;\">&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                        }
                }
