...
if ($is_adminOfCourse) {
        ...
        if (isset($_POST['submit'])) {
                            ...
                            if(empty($_SESSION['key_add_guest_user'])){
                $csrftoken_text = md5(openssl_random_pseudo_bytes(32,$cstrong));
                $_SESSION['key_add_guest_user'] = $csrftoken_text;
                }



                $csrftoken = hash_hmac('sha256','this is a random text:newtopic' . $_SESSION['key_add_guest_user'],session_id());


            if(hash_equals($csrftoken,$csrf))
            {

                //unset($_SESSION['key_add_guest_user']); 
                //$_SESSION['key_add_guest_user']='';
            ...
            else
            {
                ...
                $tool_content .= "
                        <form method='post' action='$chaaange'>
