...
if(empty($_SESSION['key_mailprof'])){
	$csrftoken_text = md5(openssl_random_pseudo_bytes(32,$cstrong));
	$_SESSION['key_mailprof'] = $csrftoken_text;
}


$csrftoken = hash_hmac('sha256','this is a random text:newtopic' . $_SESSION['key_mailprof'],session_id());
...
if (isset($_POST['submit']) && ($_POST['body_mail'] != "") && ($_POST['submit'] == $langSend)) {
    ...
    if(hash_equals($csrftoken,$csrf))
    {
        ...
        unset($_SESSION['key_mailprof']);
        $_SESSION['key_mailprof']='';
