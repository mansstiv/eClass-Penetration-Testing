...
if(empty($_SESSION['key_secureformconf'])){
  $csrftoken_text = md5(openssl_random_pseudo_bytes(32,$cstrong));
  $_SESSION['key_secureformconf'] = $csrftoken_text;
}


$csrftoken = hash_hmac('sha256','this is a random text:newtopic' . $_SESSION['key_secureformconf'],session_id());
...
if (isset($submit))  {
    ...
    if(hash_equals($csrftoken,$csrf))
    {
        ...
        unset($_SESSION['key_secureformconf']);
        $_SESSION['key_secureformconf']='';
