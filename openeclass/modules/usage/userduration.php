        ...
        $tool_content .= "
          <div id='operations_container'>
            <ul id='opslist'>
              ...
              <li>$langDumpUserDurationToFile&nbsp;(<a href='userduration.php?format=csv&token=$csrftoken'>$langCodeUTF</a>&nbsp;<a href='userduration.php?format=csv&token=$csrftoken&amp;enc=1253'>$langCodeWin</a>)</li>
            </ul>
          </div>";
