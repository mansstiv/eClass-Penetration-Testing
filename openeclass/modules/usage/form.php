...
$statsIntervalOptions =
    ...
    if(empty($_SESSION['key_statistics_form'])){
        $csrftoken_text = md5(openssl_random_pseudo_bytes(32,$cstrong));
        $_SESSION['key_statistics_form'] = $csrftoken_text;
    }

    $csrftoken = hash_hmac('sha256','this is a random text:newtopic' . $_SESSION['key_statistics_form'],session_id());
...
<form method="post">
  ...
  <tr>
    <th class="left">&nbsp;</th>
    <td><input type="submit" name="btnUgfdgfdsage" value="'.$langSubmit.'">
