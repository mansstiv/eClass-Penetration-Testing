...
if(isset($welcomeScreen) )
{
	...
	$urlAppendPath = str_replace('/install/index.php', '', $urlPath);
...
if (isset($alreadyVisited)) {
	$tool_content .= "<form action=".$urlPath."?alreadyVisited=1 method=\"post\">";
	$tool_content .= "
...
elseif (isset($_REQUEST['install1']) || isset($_REQUEST['back1']))
{
	...
	<td><form name='langform' action='$urlPath' method=\"post\">".selection($langLanguages, 'lang', $lang, 'onChange="document.langform.submit();"')."</form></td>
	</tr>
	<tr>
	<td class=\"odd\" class=\"left\">&nbsp;</td>
	<td>
	<form action='$urlPath?alreadyVisited=1' method=\"post\">
